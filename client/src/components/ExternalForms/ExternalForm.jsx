  ...
  return (
    <div className="sib-form" style={{ textAlign: 'left', backgroundColor: 'transparent' }}>
      <div id="sib-form-container" className="sib-form-container">
        ...
        <div id="sib-container" className="sib-container--large sib-container--horizontal" style={{ textAlign: 'left', backgroundColor: 'transparent', maxWidth: '540px', borderRadius: '3px', borderWidth: '0px', borderColor: '#C0CCD9', borderStyle: 'solid', direction: 'ltr' }}>
          <form id="sib-form" method="POST" action="https://48b3dfdb.sibforms.com/serve/MUIFACNPk5kat0hCZ4EGUTUQ-O7D6OayPjvJ6bavWiXuRttNxQVkJTna0xhwjWtN1UTjVL6FWfkt0DbQ81sh1W08Fn-vXdYV876XR3nyrSFY91xQ8WRXd-bXZ0MlpQz9sbaARHYqWbswsZCDrVNd_QJX5X89GPXeYNkwVmJuAvZpZ2l2ow58vmqFKJNaxINgE_tYO0sIg72tLx4G" data-type="subscription">
            <div style={{ padding: "8px 0" }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row form__label-row--horizontal">
                    <div className="entry__field">
                      <input className="input" maxLength="200" type="text" id="NOMBRE" name="NOMBRE" autoComplete="off" placeholder="Ingresa tu nombre" data-required="true" required />
                    </div>
                  </div>
            ...
            <div style={{ padding: "8px 0" }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row form__label-row--horizontal">
                    <div className="entry__field">
                      <input className="input" maxLength="200" type="text" id="APELLIDOS" name="APELLIDOS" autoComplete="off" placeholder="Ingresa tu apellido" data-required="true" required />
                    </div>
                  </div>
                  <label className="entry__error entry__error--primary" style={{ fontSize: "16px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#661d1d", backgroundColor: "#ffeded", borderRadius: "3px", borderColor: "#ff4949" }}>
                  </label>
            ...
            <div style={{ padding: "8px 0" }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row form__label-row--horizontal">
                    <div className="entry__field">
                      <input className="input" type="text" id="EMAIL" name="EMAIL" autoComplete="off" placeholder="Ingresa tu email" data-required="true" required />
                    </div>
                  </div>
                  <label className="entry__error entry__error--primary" style={{ fontSize: "16px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#661d1d", backgroundColor: "#ffeded", borderRadius: "3px", borderColor: "#ff4949" }}>
                  </label>
                  <label className="entry__specification" style={{ fontSize: "12px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#8390A4" }}>
                    Ingrese un email institucional para que su consulta sea asignada Ej.: info@empresa.com
                  </label>
                </div>
              </div>
            </div>
            <div style={{ padding: "8px 0" }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row form__label-row--horizontal">
                    <div className="entry__field">
                      <input className="input" maxLength="200" type="text" id="EMPRESA" name="EMPRESA" autoComplete="off" placeholder="Ingresa tu empresa" data-required="true" required />
                    </div>
                  </div>
                  <label className="entry__error entry__error--primary" style={{ fontSize: "16px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#661d1d", backgroundColor: "#ffeded", borderRadius: "3px", borderColor: "#ff4949" }}>
                  </label>
                  ...
                  <div className="form__label-row">
                    ...
                    <div className="sib-sms-input-wrapper" style={{ direction: "ltr" }}>
                      <div className="sib-sms-input" data-placeholder="" data-required="1" data-country-code="AR" data-whatsapp-country-code="AR" data-value="" data-whatsappvalue="" data-attributename="WHATSAPP">
                        ...
                        <label className="entry__error entry__error--secondary" style={{ fontSize: "16px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#661d1d", backgroundColor: "#ffeded", borderRadius: "3px", borderColor: "#ff4949" }}>
                        </label>
                      </div>
                    </div>
                  </div>
            ...
            <div style={{ padding: "8px 0" }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row form__label-row--horizontal">
                    <div className="entry__field">
                      <textarea rows="2" className="input" maxLength="500" id="CONSULTA" name="CONSULTA" autoComplete="off" placeholder="Dejanos tu consulta" data-required="true" required></textarea>
                    </div>
                  </div>
                  <label className="entry__error entry__error--primary" style={{ fontSize: "16px", textAlign: "left", fontFamily: "Helvetica, sans-serif", color: "#661d1d", backgroundColor: "#ffeded", borderRadius: "3px", borderColor: "#ff4949" }}>
                  </label>
